...
public class AppiraterSettings
{
	...
	/*
		 ...
		 */
	public Int32 SigEventsUntilPrompt;
	...
	/*
		 ...
		 */
	public Int32 TimeBeforeReminding;
...
public class Appirater : NSObject
{
    ...
    public Action<Boolean> OnRate;

    public Appirater (Int32 appId)
			: this (new AppiraterSettings (appId))
	{
	}

	public Appirater (Int32 appId, Boolean debug)
	...
	Boolean RatingConditionsHaveBeenMet ()
	{
		...
		Int32 useCount = (Int32)userDefaults.IntForKey(USE_COUNT);
		if (useCount < settings.UsesUntiPrompt)
			return false;

		// check if the user has done enough significant events
		Int32 sigEventCount = (Int32)userDefaults.IntForKey (SIGNIFICANT_EVENT_COUNT);
